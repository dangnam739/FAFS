...
def _resnet(arch, block, layers, pretrained, progress, with_ibn, replace_stride_with_dilation=[False, False, False], freeze_bn=False, **kwargs):
...
# -----------------------------------------------------------------------------
# DeepLab ResNet replace_stride_with_dilation for deeplab
# -----------------------------------------------------------------------------
...
@BACKBONE.register("R-DL-50-C1-C5-FREEZEBN")
