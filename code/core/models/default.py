...
_C.DATASET.USE_RANDAUG = False
_C.DATASET.USE_FFT = False  #Apply fourier transform
_C.DATASET.FFT_BETA = 0.0
_C.DATASET.FFT_MODE = "RGB"
...
_C.DATASET.TARGET.ENT_LOSS_WEIGHT = 0.0
_C.DATASET.TARGET.ENT_ITA = 2.0
...
_C.DATASET.TARGET.PSEUDO_PREV_UPDATE = False #use update from previous pseudo label
...
_C.TEST.USE_MST = False # Multi scale test
_C.TEST.VISUALIZE = False
_C.TEST.VISUALIZE_DIR = None
_C.TEST.EXTRACT_CONFUSION_MATRIX = False
